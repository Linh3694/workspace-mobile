export const ROUTES = {
  ...
  SCREENS: {
    ...
    /** Quét tem QR dán trên máy để mở thẳng hồ sơ thiết bị. */
    ...
    /** Hàng chờ duyệt đặt phòng — chỉ hiện với người thực sự có phiếu chờ */
    ROOM_BOOKING_APPROVAL: 'RoomBookingApproval',
