...
import HospitalDiagnosisForm from './components/HospitalDiagnosisForm';

type Nav = NativeStackNavigationProp<RootStackParamList>;
type Params = RouteProp<RootStackParamList, typeof ROUTES.SCREENS.HEALTH_EXAM_HOSPITAL>;

/**
 * Màn full-screen nhập chẩn đoán BV (thay cho bottom sheet — layout thoáng hơn)
 */
const HospitalDiagnosisScreen: React.FC = () => {
...
export default HospitalDiagnosisScreen;
